...
const EcommerceAppContext = () => {
    ...
    // const appContextProvider = useContext(AppContextProvider);
    // console.log(`appContextProvider`, appContextProvider);

    const { screenWidth } = getWindowDimensions();

    return (
        <>
            {/* <ScrollPositionContext.Provider value={scrollYPosition}> */}
                    ...
                    <>
                        <BrowserRouter>
                            ...
                            <Routes>
                                ...
                                {/* <Fragment> <Navigate to="/" replace={true} /> </Fragment> */}
                            </Routes>
                        </BrowserRouter>
                    </>
                ) : (
