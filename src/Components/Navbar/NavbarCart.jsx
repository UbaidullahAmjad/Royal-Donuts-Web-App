...
const NavbarCartBox = styled("div")`
  ...
  width: 400px;
  top: 45px;
  /* top: ${(props) => (props.screenWidth > 768 ? "45px" : "auto")}; */
  left: 0;
  /* bottom: ${(props) => (props.screenWidth > 768 ? "auto" : "45px")}; */
  /* bottom: auto; */
  transform: translateX(-86%);
  padding: 1rem 0.75rem;
  border-radius: 6px;
  /* box-shadow: 0px 5px 10px rgb(51 51 51 / 35%); */
  ...
  @media (max-width: 800px) {
    ...
    /* bottom: 45px; */
    /* bottom: ${(props) =>
    props.deviceType == "Mobile" ? "66px" : "45px"}; */
    bottom: 66px;
...
const NavbarCart = (props) => {
  ...
  console.log(`product 121 -------------------------`, products);
...
export default translate(NavbarCart);
