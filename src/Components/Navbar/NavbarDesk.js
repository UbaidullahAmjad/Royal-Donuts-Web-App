...
// console.log("language_cookie", cookies.get('language_cookie'))
// Decrypt
...
console.log("bytesIsCookieAllow -----", bytesIsCookieAllow.toString());
...
setDefaultLanguage(
  isCookieAllowDecode == true && cookies.get("language_cookie")
...
const NavbarDesk = (props) => {
  ...
  const handleSetLanguage = () => {
    ...
    console.log("languageCookieDecode_after:", languageCookieDecode);
    console.log(
      "languageCookieDecode-type_after:",
      typeof languageCookieDecode
    );
  };

  const handleLoginDropdown = () => {
    console.log("handleLoginDropdown clicked");
  ...
  useEffect(() => {
    ...
    if (isCookieAllowDecode == true) {
      // if (cookies.get('language_cookie') && cookies.get('language_cookie') == "en") {
...
export default translate(NavbarDesk);
