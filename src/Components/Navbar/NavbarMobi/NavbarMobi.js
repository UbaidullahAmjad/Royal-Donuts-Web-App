...
const NavbarMobi = (props) => {
  ...
  const handleSetLanguage = () => {
    if (getLanguage() === "en") {
      ...
      if (isCookieAllowDecode == true) {
        var cookie_expires_date = new Date();
  ...
  // const scrollPostion = useContext(ScrollPositionContext);

  // console.log(`</scrollPostion.Consumer>`, scrollPostion);
  ...
  const getHomeSettings = async () => {
    await axios
      ...
      .then((response) => {
        // console.log("home-nav-responssss", response);
                        ...
                        >
                          <AccordionNavbar.Item>
                            ...
                            <AccordionNavbar.Body>
                              {/* <div className="mb_navbar_items_box">
                                <KeyboardArrowRightIcon className={"arrow_icon"} />
                                <p className="mb_navbar_items disabled" style={{ cursor: 'default' }}>
                                  {localStorage.getItem("name")}
                                </p>
                              </div> */}
                              <div className="mb_navbar_items_box">
...
export default translate(NavbarMobi);
