...
const ScrollupFloatingButton = (props) => {
    ...
    // const { scrollYPosition, setScrollYPosition } = props;
    ...
    const listenToScroll = () => {
        ...
        if (window.location.pathname.includes("/produit/")) {
            // console.log("currentPage", window.location.pathname.includes("/produit/"))
            if (scrolled >= 0.24) {
    ...
    // console.log("App.js-bottomCartBtnMargin", bottomCartBtnMargin)
    // console.log("App.js-scrollYPosition", scrollYPosition)
