...
// import { zipCodeDistance, getRadius } from "zipcode-city-distance";
...
const CartPage = (props) => {
  ...
  // let open_time_hours = store != null && store?.open_time?.split(":")[0];
  // let open_time_minuts = store != null && store?.open_time?.split(":")[1];
  // let open_time_hours = null;
  // let open_time_minuts = null;
  // let close_time_hours = null;
  // let close_time_minuts = null;
  ...
  useEffect(() => {
    ...
    console.log(`store_day_number ------------------`, storedays);
  ...
  const handleNextCheckout = (objectData) => {
    ...
    console.log("checkTab Values-checkTab_1", checkTab_1)
    console.log("checkTab Values-checkTab_2", checkTab_2)
    console.log("checkTab Values-checkTab_3", checkTab_3)
                          ...
                          >
                            ...
                            {products.map((product) => {
                              return (
                                ...
                                // itemQtyTotal={product?.itemQtyTotal}
                                />
                              );
                            })}
                          </div>
                                      ...
                                      {zipCode !== "" &&
                                        ...
                                        valueDateRange[0] !== null && (
                                          <div className="cartpage_next_btn_wrapped d-flex justify-content-center">
                                            {/* <Button className="cartpage_next_btn" disabled={termsCondition || valueDateRange[1] === null || storeValue === ""} onClick={() => handleNextCheckout()}>Next</Button> */}
                                            <Button
                                        ...
                                        <div>
                                          <Select
                                            ...
                                            onChange={(e) => {
                                              ...
                                              // dispatch(checkoutFormPushData({ key: "delivery_info", value: e.target.value }))
                                            }}
                                          >
                                            <MenuItem
                                              onClick={() =>
...
export default translate(CartPage);
