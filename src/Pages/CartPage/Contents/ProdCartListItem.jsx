...
const CartPageItem = (props) => {
  ...
  //   product_info ? product_info.product_detail?.quantity : 0
  // );

  console.log("Product information", product_info);
          ...
          <>
            ...
            {product_info.topping?.length > 0 &&
              product_info.topping.map((top, i) => {
                if (i == 0) {
                  return (
                    <img className="img-fluid topping_layer" src={top.image1} />
                  );
                }
                if (i == 1) {
                  return (
                    <img className="img-fluid topping_layer" src={top.image2} />
                  );
                }
                if (i == 2) {
                  return (
                    <img className="img-fluid topping_layer" src={top.image3} />
                  );
                }
              })}
...
export default translate(CartPageItem);
