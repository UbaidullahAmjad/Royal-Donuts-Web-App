...
import CheckOutProducts from "./Contents/CheckOutProducts";
...
const CheckOutUser = (props) => {
  ...
  // console.log("getCheckoutGetUser", userInfo)
  ...
  useEffect(() => {
    ...
    // console.log("checkoutFormData-Guest: useeffect", checkoutFormData);
  ...
  useEffect(() => {
    console.log("USER _INFo ---", userInfo == "");
    ...
    if (userInfo != undefined && userInfo != null && userInfo != "") {
      ...
      console.log("bytes ***********", bytes, "userInfo *****", userInfo)
      ...
      console.log("USER _INFo DEC 11 11 ---", decrypted_UserInfo);
    }
  }, [userInfo]);
          ...
          <div className="row m-0">
            ...
            <div className="col-md-6 ps-0 ps-md-1 pe-0">
              <div className="mb-3" controlId="delivery_l_name">
                {/* <Form.Label className="co__label_delivery">
                        {trans("Last Name")}
                      </Form.Label> */}
                <TextField
                  InputLabelProps={{
...
export default translate(CheckOutUser);
