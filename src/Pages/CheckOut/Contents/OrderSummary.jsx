...
const OrderSummary = (props) => {
  ...
  // const { setTotalPayPrice, set_coupon_code, setCouponCodeAmount, setCouponCodeSymbol } = props;
  ...
  const getCoupon = async () => {
    ...
    // var config = {
    //   method: "get",
    //   url: `${URL}/checkcoupon?id=${cartId}&coupon=${discountCode.toString()}`,
    // };
    axios
      .get(`${URL}/checkcoupon`, {
    ...
    <div className="co__order_summary co_new_order_summary mb-2">
      ...
      <div className="row m-0">
        ...
        <div className="col-9 pe-1_ ps-0">
          {/* <Form.Control
            type="text"
            className="co__input form_labels"
            name="coupon"
