...
const Invoice = (props) => {
  ...
  // console.log(
  //   "DELIVEFY --- ",
  //   delivery_data_info && delivery_data_info != null && delivery_data_info
  // );
  // console.log("ORDER --- ", order && order != null && order);

  // console.log(
  //   "name --- ",
  //   location?.state?.allData &&
  //     location?.state?.allData != null &&
  //     location?.state.allData
  // );
                      ...
                      <TableCell align="right">
                        <div className="d-flex flex-column ">
                          <strong>
                            ...
                            {order.total.toFixed(2).split(".").length > 1 && trans("dot")}
                            {order.total.toFixed(2).split(".").length > 1 && 
                            order.total.toFixed(2).split(".")[1]}{" "}
                            <span>€</span>
                          </strong>
                          <strong>
                          ...
                          <strong>
                            ...
                            {order.grand_total.split(".").length > 1 && trans("dot")}
                            {order.grand_total.split(".").length > 1 && order.grand_total.split(".")[1]} <span>€</span>
                          </strong>
                        </div>
                      </TableCell>
                    </TableRow> */}
...
export default translate(Invoice);
