...
const PaymentBox = (props) => {
  ...
  // console.log("HANDLE 1212 ---------------", handle);

  const Toggle = (id) => {
    setOpen(id.toString());
    console.log("IDDDDDDDD -----", id, " --- OPEN -----", open);
  };
  ...
  const onSubmit = (data) => {
    console.log("onsubmit 12345 -------", data);
  ...
  function handleLoadingChange(newValue) {
    console.log("VALUEEE LOADING --------------------------", newValue);
    setLoadingState(newValue);
  }

  // console.log("SUBMISSION GetLoadingState ------------------", open);
        ...
        <div className="row">
          ...
          {/* <div className="col-6" style={{ padding: "0px 15px" }}>
            <Button
              ...
              className="form-control back_to_shipment_btn"
              variant="danger"
              style={{ marginTop: 9 }}
            >
              {open == 2
...
export default translate(PaymentBox);
