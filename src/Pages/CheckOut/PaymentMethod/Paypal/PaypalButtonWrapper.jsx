...
const PaypalButtonWrapper = ({
    ...
    useEffect(() => {
        console.log("PAYPAL INVOICE DATA ------------", paypalInvoiceData);
    }, [paypalInvoiceData])
    ...
    console.log("PAYPAL -valid ----- ", paypal_123);
    return (
        <>
            <ToastContainer />
            {isPending === true && (
                ...
                onApprove={function (data, actions) {
                    if (amount) {
                        return actions.order.capture().then(function () {
                            ...
                            // console.log("PaypalPayment - createorder: ", allData);
                            // reduxDispatch(getPaypalEccomCartAction());
                            ...
                            axios(config)
                                .then(async (response) => {
                                    console.log("paypal-eccom_cart-resp", response)
