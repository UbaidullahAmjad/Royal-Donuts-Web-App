...
const checkOutTabs = (props) => {
    ...
    // const showGuestTabOnTabLogin = location.state ? (location.state.showGuestTabOnTabLogin ? location.state.showGuestTabOnTabLogin : true) : true;
...
export default translate(checkOutTabs)