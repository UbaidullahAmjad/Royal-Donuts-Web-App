...
const CarouselSettings = (props) => {
  ...
  // console.log("slides_array-reducer", slides_array);
  ...
  const onSubmit = (data) => {
    ...
    axios
      ...
      .then((response) => {
        console.log("response-carousel_setting", response);
  ...
  const onEditSubmit = (data) => {
    ...
    console.log("carousel_response_data-onEditSubmit", data);
    const form = new FormData();
          ...
          <div className="col-md-12">
            {slides_array?.length > 0 &&
              slides_array.map((item) =>
                console.log("slides_array-item", item)
              )}
            {slides_array?.length > 0 &&
              slides_array.map((item) => (
                <Form
                          ...
                          <Controller
                            ...
                            render={() => (
                              <CKEditors
                                ...
                                events={{
                                  change: (event) =>
                                    EditFirstHeadingChange(event, item.id),
                                }}
                              />
                            )}
                          />
                          ...
                          <Controller
                            ...
                            render={() => (
                              <CKEditors
                                ...
                                events={{
                                  change: (event) =>
                                    EditSecondHeadingChange(event, item.id),
                                }}
                              />
                            )}
                          />
