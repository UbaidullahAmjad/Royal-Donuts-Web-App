export const DonutComparison = (get_customized_donut_array, confirm_order) => {
  ...
  if (get_customized_donut_array?.length > 0) {
    for (const item of get_customized_donut_array) {
      // console.log("GET ITEM OF ARRAY IN LOOP ------------------", item);
      // GLAZES ----------  SAUCES ---------- FILLINGS ----------- TOPPINGS
      if (
      ...
      // GLAZES ----------  SAUCES ---------- FILLINGS
        ...
        if (item?.topping?.length == 0) {
          console.log("GLAZES ----------  SAUCES ---------- FILLINGS -----");
          item_data = item;
          break;
        }
      }
      ...
      // GLAZES  ---------- FILLINGS ----------- TOPPINGS
        ...
        if (item?.sauce?.length == 0) {
          console.log("GLAZES  ---------- FILLINGS ----------- TOPPINGS");
          item_data = item;
          break;
        }
      }
      // FILLINGS ---------- SAUCES ----------- TOPPINGS
        ...
        if (item?.glazes?.length == 0) {
          console.log("FILLINGS ---------- SAUCES ----------- TOPPINGS");
          item_data = item;
          break;
        }
      }
      ...
      // TOPPINGS
        ...
        (item.topping.filter(
          ...
          // confirm_order?.topping[index] != undefined &&
          // item2.name == confirm_order?.topping[index]["name"]
        )?.length ==
          item.topping?.length) ==
          (confirm_order?.topping.length ==
            item.topping.filter((item2, index) =>
