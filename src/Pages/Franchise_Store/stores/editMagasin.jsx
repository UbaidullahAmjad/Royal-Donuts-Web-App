...
const CreateMagasin = (props) => {
  ...
  const handleHeaderImageValidate = (validate) => {
    console.log(`validate ----------`, validate.meta.status);
    ...
    if (validate?.meta?.status == "error_file_size") {
      validate.remove();
      setError("header_image", {
        type: "string",
  ...
  const onSubmit = (data) => {
    ...
    dispatch(StoreEditAction(formData, params.idd));
  };
  ...
  useEffect(() => {
    const getData = async () => {
      ...
      setHeaderImage(response.data?.store?.header_image);
      ...
      setContent(response.data.store.description_en);
    };
    getData();
    getZeltyStatus();
  }, []);
  ...
  return (
    <Fragment>
      <Breadcrumb
        breadcrumbtitle={trans("Edit") + " " + trans("Store")}
                  ...
                  <div className="form-row">
                      ...
                      <div className="container d-flex justify-content-center align-items-center mt-3">
                        {image != null && (
                          <img
                            width={100}
                            height={100}
                            src={`${SIMPLE_URL}/images/Store/${image}`}
                            alt={"alt"}
                            onError={(e) => {
                      ...
                      <div className="container d-flex justify-content-center align-items-center mt-3">
                        {HeaderImage != null && (
                          <img
                            width={100}
                            height={100}
                            src={`${SIMPLE_URL}/images/Store/header/${HeaderImage}`}
                            alt={"alt"}
                            onError={(e) => {
                              e.currentTarget.src = logo;
                            }}
                    ...
                    <Col md="12 mb-3">
                      ...
                      <Controller
                        ...
                        name="description_en"
                        rules={{ required: false }}
                        key={StoreData != null && StoreData.description_en}
                        defaultValue={
                          StoreData != null && StoreData.description_en
                        }
                        render={() => (
                          <CKEditors
                            activeclassName="p10"
