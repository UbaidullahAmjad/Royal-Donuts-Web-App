...
const SupplierCustomerList = (props) => {
  ...
  console.log("supplierCustomersList", customerList)
    ...
    if (name === "alertDanger") {
      SweetAlert.fire({
        ...
        if (result.value) {
          ...
          dispatch(DeleteSupplierCustomerAction(id))
          SweetAlert.fire({
            icon: "success",
            title: trans("Deleted"),
          ...
          <Card>
            ...
            <CardBody>
              <DataGrid
                ...
                isLoading={customerList.supplierCustomersList?.length == 0 ? true : false}
              />
            </CardBody>
          </Card>
        </Container>
...
export default translate(SupplierCustomerList);
