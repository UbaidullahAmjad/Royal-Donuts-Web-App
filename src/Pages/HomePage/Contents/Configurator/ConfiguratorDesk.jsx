  ...
  return (
    <>
      ...
      >
        <div>
          <img
            src="/images/configurator_design_5.png"
            id="config_img"
            alt="configurator_design_5.png"
        ...
        <div>
          <Grid container>
            ...
            <Grid item xs={4} sm={4} md={4} style={{ display: "flex" }}>
              ...
              />
              {/* <img src="/images/donut_shadow.png" id="shadow_config_image1" /> */}

              <img
                src="/images/config_2.png"
                id="config_image2"
                alt=""
                onLoad={() => setLoadedImage4(true)}
              />
              {/* <img src="/images/donut_shadow.png" id="shadow_config_image2" /> */}
            </Grid>
            <Grid
              item
              xs={2}
...
export default translate(ConfiguratorDesk);
