...
const products = (props) => {
  ...
  // const urlb = "http://localhost/Donut_app_2/public";
  ...
  const ToggleHomeProductPage = () => {
    console.log("GOT TOOGLE ToggleHomeProductPage");
  ...
  return (
    <>
      ...
      >
        {/* <CustomButton id="product_category">Meilleur</CustomButton>
        <CustomButton id="product_category">En vedette</CustomButton>
        <CustomButton id="product_category">Fraiche</CustomButton> */}
      </div>
      <Container>
        <Row
