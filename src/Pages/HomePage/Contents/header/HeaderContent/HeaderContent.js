...
const HeaderContent = () => {
  ...
  console.log("HomeCarouselList", CarouselData)
  console.log("HomeCarouselList-loading", loading)
  console.log("HomeButtonColor", HomeButtonColor)

  useEffect(() => {
    dispatch(HomeCarouselGetData())

    // if (getHomeCarousel.loading == false || CarouselData.length > 0) {
    //   setloading(false);
    // }
  ...
  console.log(
    "Slider Data ================================",
    CarouselData,
    " --- SliderData[activeSlider2]",
    SliderData["activeSlide"]
  );

  console.log("LOADING SLIDER", loading);
  return (
                                  ...
                                  >
                                    ...
                                    >
                                      <CustomButton
                                        id="imp_button"
                                      // style={{
                                      //   backgroundColor: HomeButtonColor != null && HomeButtonColor != "" ? HomeButtonColor : defaultHomeButtonColor,
                                      // }}
                                      >
                                        <p
                                          dangerouslySetInnerHTML={{
