...
const CoupenList = (props) => {
  ...
  // console.log("couponsList", coupens)
  ...
  const bulkDeleteApiCall = (bulkIds) => {
    dispatch(CouponsBulkDeleteAction(bulkIds));
    // await axios({
    //   method: "POST",
  ...
  const columns = [
    ...
    },
    {
      ...
      minWidth: 120,
      render: (cellValues) => {
        console.log("cell values", cellValues.isActive);
        ...
        <Card>
          ...
          <CardBody>
            <DataTable
              ...
              isLoading={coupens.couponsList?.length == 0 ? true : false}
            />
          </CardBody>
