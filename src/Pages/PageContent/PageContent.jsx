...
const PageContent = (props) => {
  ...
  console.log("PARAMS UR l-------------", page_url);
  // console.log(
  //   "location.state.page_id: ",
  //   `${location.state != null && location.state.page_id}`
  // );
  ...
  // console.log("----PageContent_SEO", PageSEOContent)
  // console.log("----Eccom_SEO", Eccom_SEO)

  useEffect(() => {
    window.scrollTo(0, 0);

    const findPageUrl = PagesContentList.some((page) => page.page_url == page_url)
    console.log("findPageUrl", findPageUrl)
  ...
  return (
    <>
      {PageSEOContent != null && (
        <Helmet>
          {/* <title>{PageSEOContent.meta_title != null ? PageSEOContent.meta_title : Eccom_SEO.meta_title}</title> */}
          <title>
