...
const Product = (props) => {
  ...
  // console.log("iddddddddddd-id", id);
  // console.log("iddddddddddd-slug", slug);
  // console.log("iddddddddddd-fr_name", product);
  ...
  // console.log("ppppppp---cartItemQuantity_test", cartItemQuantity_test);
  // console.log("ppppppp---detailPageCartItem", detailPageCartItem);
  // console.log("ppppppp---cartItemQuantity", cartItemQuantity);

  const theme = useTheme();
  const [click, setClick] = useState(0);
  const [value, setValue] = useState(1);

  // const [item_stock_check, set_item_stock_check] = useState(0);
  ...
  // console.log("getProductDetail-getProductDetail", getProductDetail)
  // console.log("getProductDetail-prodsDetailList", prodsDetailList)
  // console.log("getProductDetail-productDetail", productDetail)
  // console.log("getProductDetail-AllImages", AllImages)
  // console.log("getProductDetail-ProductAllergen", ProductAllergen)
  // console.log("getProductDetail-ProductLayer", ProductLayer)
  // console.log("getProductDetail-ProductLayer2", ProductLayer2)
  // console.log("getProductDetail-relatedProducts", relatedProducts)
  // console.log("getProductDetail-ProductDetailSEO", ProductDetailSEO)
  // console.log("getProductDetail-Eccom_SEO", Eccom_SEO)
  ...
  console.log("prod-setValue", value);
  ...
  // let prod_detail_path = window.location.pathname.includes("/produit/")
  ...
  const incrementQuantity = () => {
    ...
    if (cartItemQuantity != undefined) {
      if (cartItemQuantity > 0) {
        // disptach(incrementItemQuantity({ id: product_id, quantity: cartItemQuantity + 1 }))
        disptach(
          incrementItemQuantity({
            id: ProductDescription.id,
  ...
  console.log(
    "datacheck-ProductDetailSEO",
    ProductDetailSEO != null && ProductDetailSEO
  );
  console.log("datacheck-Eccom_SEO", Eccom_SEO != null && Eccom_SEO);
  return (
    <>
      {ProductDetailSEO != null && (
        <Helmet>
