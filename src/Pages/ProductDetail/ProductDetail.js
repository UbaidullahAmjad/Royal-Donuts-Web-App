      ...
      <Container style={{ marginTop: "7%" }}>
        <Card style={{ border: "none", boxShadow: "none" }}>
          <CardContent>
                ...
                <div style={{ marginLeft: 20 }}>
                  ...
                  {/* <div style={{ display: "flex" }}>
                    {Array.from({ length: 5 }, (i) => (
                      <img
                        src="/images/product_star.png"
                        height={16}
                        style={{ marginLeft: 2 }}
                        key={i}
                      />
                    ))}
                    <h6 style={{ marginTop: "-1px", marginLeft: 5 }}>
                      ( 0 - {trans("Customer Review")})
                    </h6>
                  </div> */}
                          ...
                          ProductLayer2.map((item, index) => (
                            <p key={index}>
                              {item.map((item2, index2) =>
                                // item2.layer_data.name_fr == "Remplissage"
                                //   ? index2 > 0
                                //     ? "," + item2.name_fr
                                //     : item2.name_fr
                                //   : ""
                  ...
                  large_mobile == false ? (
                    <div style={{ display: "flex", alignItems: "baseline" }}>
                      ...
                      ProductLayer.map((item2, index2) => (
                        <p>
                          {item2.layer_data.name_fr == "Glaçage"
                            ? index2 > 0
                              ? "," + item2.name_fr
                              : item2.name_fr
                            : ""}
                    ...
                    <div style={{ display: "flex", alignItems: "baseline" }}>
                      ...
                      {ProductLayer2 != null &&
                        ProductLayer2.map((item, index) => (
                          <p key={index}>
                            {item.map((item2, index2) =>
                              // item2.layer_data.name_fr == "Garniture"
                              //   ? index2 > 0
                              //     ? "," + item2.name_fr
                              //     : item2.name_fr
                              //   : ""
                    ...
                    <div style={{ display: "flex", alignItems: "baseline" }}>
                      ...
                      {ProductLayer2 != null &&
                        ProductLayer2.map((item, index) => (
                          <p key={index}>
                            {item.map((item2, index2) =>
                              // item2.layer_data.name_fr == "Sauce"
                              //   ? index2 > 0
                              //     ? "," + item2.name_fr
                              //     : item2.name_fr
                              //   : ""
                  ...
                  {ProductAllergen != null && ProductAllergen.length > 0 && (
                    <div>
                      {/* <h3 style={{ marginTop: 40 }}>{trans("Base Donut")}</h3> */}
                      <div
                        style={{
                          display: "flex",
                          flexDirection: "row",
                      ...
                      >
                        ...
                        <div style={{ display: "flex", flexDirection: "row" }}>
                          ...
                          {/* <img
                          src="/images/Header/allergen_2.png"
                          style={{ width: "100%", height: "50px" }}
                        />
                        <img
                          src="/images/Header/allergen_1.png"
                          style={{ width: "100%", height: "50px" }}
                        />
                        <img
                          src="/images/Header/allergen_2.png"
            ...
            <hr></hr>
            <div>
              {/* <h2 style={{ textAlign: "center", color: "#F5A22C" }}>
                ...
                <Grid item xs={12} sm={12} md={12} lg={12}>
                  <Row>
                    ...
                    {/* <Grid item xs={12} sm={6} md={4} lg={4}>
                      <ProductDetailCard
                        product={{
                          image: "/images/Header/right_donut_image.png",
                          name_fr: "Bouncy Bomg",
                          price_euro: "3.80",
                        }}
                      />
...
export default translate(ProductDetail);
