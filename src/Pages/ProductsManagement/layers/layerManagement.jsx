...
const LayerManagement = (props) => {
  ...
  console.log("layersList", layersData)
  ...
  const bulkDeleteApiCall = async (bulkIds) => {
    dispatch(LayersBulkDeleteAction(bulkIds))
  };
        ...
        <Card>
          ...
          <CardBody>
            <DataTable
              ...
              isLoading={layersData.layersList.length == 0 ? true : false}
            />
          </CardBody>
