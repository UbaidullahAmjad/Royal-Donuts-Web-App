...
const Products = (props) => {
  ...
  const bulkDeleteApiCall = (bulkIds) => {
    dispatch(ProductsBulkDeleteAction(bulkIds))
  };

  const handleIsBoxes = (prodId, message) => {
    dispatch(HandleIsProdBoxAction(prodId, message));
    console.log("--PRODUCTS_IS_BOX-allProducts", allProducts)
  };

  const handleIsSpecialProducts = (prodId, message) => {
    // console.log("prodId: ", prodId);
    dispatch(HandleIsProdSpecialAction(prodId, message));
    console.log("--PRODUCTS_IS_SPECIAL-allProducts", allProducts)
  };

  const handleIsActive = (prodId, message) => {
    dispatch(HandleIsProdActiveAction(prodId, message));
    console.log("--PRODUCTS_IS_ACTIVE-allProducts", allProducts)
  };
        ...
        <Card>
          ...
          <CardBody>
            <DataTable
              ...
              isLoading={allProducts.productsList.length == 0 ? true : false}
            />
            {/* <h1>hehre</h1> */}
          </CardBody>
