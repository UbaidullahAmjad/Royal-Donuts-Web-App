...
import Instagram from "../HomePage/Contents/Instagram/Instagram";
...
import backgroundImage from "../../assets/single_store_donuts.png";
...
const InfoPage = (props) => {
  ...
  console.log(`stores paramsssss -------`, store);
  ...
  // console.log("getStoreData-getStoreData", getStoreData)
  // console.log("getStoreData-storeContentList", storeContentList)
  // console.log("getStoreData-stores", stores)
  // console.log("getStoreData-storeDays", storeDays)
  // console.log("getStoreData-storeImageGallery", storeImageGallery)
  // console.log("getStoreData-instagramToken", instagramToken)
  // console.log("getStoreData-storeSEOTags", storeSEOTags)
  // console.log("getStoreData-Eccom_SEO", Eccom_SEO)
  ...
  useEffect(() => {
    if ((params == null || params.id == undefined) && store.idd == undefined) {
      ...
      console.log("findStoreUrl", findStoreUrl)
                                      ...
                                      <Stack sx={{ width: "100%" }} spacing={2}>
                                        <Alert icon={false} severity="error">
                                          <h6 style={{ letterSpacing: "2px" }}>
                                            {trans(
                                              "Your Instagram Token is Invalid"
                                            )}
                                            . {instagramToken}
                                          </h6>
                                        </Alert>
