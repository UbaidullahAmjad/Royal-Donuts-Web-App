...
const LeftColumn = (props) => {
  ...
  // isSkeleton
  // console.log("StoreData-isSkeleton", isSkeleton)
  ...
  // useEffect(() => {
  //   console.log("StoreData-StoreData.length", StoreData.length)

  //   return () => {
  //     console.log("StoreData-StoreData.length-2", StoreData.length)
...
export default translate(LeftColumn);
