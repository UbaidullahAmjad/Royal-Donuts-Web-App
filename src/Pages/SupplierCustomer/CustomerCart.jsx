...
const CustomerCart = (props) => {
  ...
  console.log("getSuppllierCustomerCartData", getSuppllierCustomerCartData)
  ...
  const getSupplier_Customer_Delivery_DatesCall = async (store_id, suppliers_id) => {
    console.log("customer_id", atob(localStorage.getItem("user_id")))

    const deliveryDatesResponse = await SupplierCustomerDeliveryDatesAction(store_id, suppliers_id)
    // console.log("deliveryDatesResponse", deliveryDatesResponse)
  ...
  const SubmitDeliveryCompanyData = async (delivery_company_id) => {
    console.log("delivery_company_id", delivery_company_id)
    ...
    if (delivery_company_id == "no_delivery_company") {
      ...
      console.log("CUSTOMER ID SUBMIT -AssociatedSupplier-id --- ", AssociatedSupplierData.id);
      console.log(
      ...
      // console.log("OrderConfirmedResponse", OrderConfirmedResponse)
  ...
  const DeleteProduct = async (row) => {
    ...
    SweetAlert.fire({
      ...
      if (result.value) {
        ...
        // console.log("cartItemRemoveResponse", cartItemRemoveResponse)
  ...
  useEffect(() => {
    ...
    console.log("selectedStore-useeffect", selectedStore)
  }, [valueChanged]);
  ...
  useEffect(() => {
    ...
    let selected = JSON.parse(localStorage.getItem("selected_store"));
    console.log("selectedStore-selected-2", selected)
...
export default translate(CustomerCart);
