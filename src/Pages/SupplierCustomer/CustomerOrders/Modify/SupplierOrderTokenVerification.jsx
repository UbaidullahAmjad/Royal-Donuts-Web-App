                ...
                <div className="col-sm-12 col-md-12 col-lg-12">
                  <Card className="p-3 mt-4" style={{ minHeight: 120 }}>
                    <CardHeader className="py-4">
                      <h4 className="text-center">{trans("Suppplier Order Verification")}</h4>
                    </CardHeader>
                    <CardBody>
                      {loading == true ? <div className="d-flex align-items-center justify-content-center">
                      ...
                      </div> : <>
                        {
                          suppliderTokenResponse != null ? <div className="">
                            {/* Token Verified */}
                          </div> : <div className="-flex align-items-center justify-content-center">
                            <span>Sorry! Your Supplier Order is not verified...</span>
                            <Button variant="primary" className="ml-2" onClick={supplierTokenApiCall}>{"Verify Again"}</Button>
                          </div>
                        }
                      </>}
                    </CardBody>
...
export default translate(SupplierOrderTokenVerification);
