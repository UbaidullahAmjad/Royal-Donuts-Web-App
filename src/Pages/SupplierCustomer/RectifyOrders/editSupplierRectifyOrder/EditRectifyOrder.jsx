...
const EditRectifyOrder = (props) => {
  ...
  // console.log("RectifyOrderData", RectifyOrderList)
  ...
  const DeleteProduct = async (row) => {
    ...
    console.log("CART DATAAA ---- default22 ---- ", RectifyOrderList);
    console.log("PRODUCT CART DATA ---- ", ProductCart);
  ...
  const SubmitCartItems = async () => {
    if (ProductCart.length > 0) {
      ...
      if (localStorage.getItem("user_id") != null) {
        ...
        console.log("rectifyAddResponse", rectifyAddResponse)
...
export default translate(EditRectifyOrder);
