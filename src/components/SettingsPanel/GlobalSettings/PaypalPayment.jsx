...
const PaypalPayment = (props) => {
  ...
  console.log("GetPaypalData", GetPaypalData);

  useEffect(() => {
    // console.log("StripePaymentData-useeffect called")
  ...
  // console.log("PaypalPaymentData.isActive", PaypalPaymentData?.isActive);

  const handleShowPaypal = (event) => {
    // setPaypalIsActive(event.target.checked);
    console.log("handleShowPaypal", event.target.checked);
    if (event.target.checked == true) {
      console.log("true", event.target.checked);
      setActiveStatus(1);
    } else if (event.target.checked == false) {
      console.log("falsess", event.target.checked);
      setActiveStatus(0);
    }
  };
  ...
  const onSubmit = (data) => {
    ...
    console.log("PaypalPayment - submitted activeStatus:", activeStatus);
    formData.append("isActive", activeStatus);

    dispatch(PaypalPaymentSaveDataAction(formData))
  };
