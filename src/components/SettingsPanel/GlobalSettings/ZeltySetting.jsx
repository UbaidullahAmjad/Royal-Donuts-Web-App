...
const ZeltySetting = (props) => {
  ...
  // console.log("ZeltySettings", ZeltySettings);

  useEffect(() => {
    // console.log("ZeltySettings-useeffect called")
  ...
  useEffect(() => {
    // console.log("ZeltySettings-useeffect-2 called")
  ...
  const onSubmit = (data) => {
    ...
    dispatch(ZeltySettingSaveDataAction(formData))
  };

  console.log("ZeltySettings-setAcitve", activeStatus);
  console.log("ZeltySettings-zelty token", zeltyToken);
