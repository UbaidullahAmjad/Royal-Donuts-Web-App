...
const CreateLeadForm = (props) => {
  ...
  const onSubmit = () => {
    ...
    if (progress_status == "") {
      ...
      dispatch(LeadFormCreateAction(formData))
    }
  };
  ...
  const handleSubmitData = () => {
    axios({
      ...
      // url: `${URL}/formss?form_fields=${JSON.stringify(form_fields)}&name=${name}&progress_status=${progress_status}`,
      url: `${URL}/formss`,
      data: {
        form_fields: JSON.stringify(form_fields),
        name: name,
  ...
  return (
    <Fragment>
      ...
      <Breadcrumb
        breadcrumbtitle={trans("Create") + " " + trans("Form")}
        parent={trans("CRM")}
