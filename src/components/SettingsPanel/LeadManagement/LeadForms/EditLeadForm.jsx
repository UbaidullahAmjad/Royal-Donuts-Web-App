...
const EditLeadForm = (props) => {
  ...
  const onSubmit = (e) => {
    ...
    dispatch(LeadFormEditAction(formData, idd))
  ...
  useEffect(() => {
    const getAllForms = async () => {
      ...
      if (response.data.success === true) {
        ...
        console.log("EditLeadForm-response", response);
  ...
  console.log("DEFAULT OPTIONS ---- ", AllOptions);
      ...
      if (option_find) {
        ...
        if (new_option_names.length > 0) {
          ...
          if (option_find_check) {
            ...
            console.log("option_find_from_update", option_find_from_update);
  ...
  return (
    <Fragment>
      ...
      <Breadcrumb
        breadcrumbtitle={trans("Edit") + " " + trans("Form")}
        parent={trans("CRM")}
...
export default translate(EditLeadForm);
