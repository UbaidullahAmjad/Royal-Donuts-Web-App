...
const Products = (props) => {
  ...
  console.log("dayyyy", singleDay);
  console.log("store days", storeDays);
                  ...
                  <div className="form-row">
                    ...
                    {/* <Col md="12 mb-3">
                      ...
                      <Input
                        ...
                        type="text"
                        placeholder={trans("Enter the Instagram")}
                        innerRef={register({ required: true })}
                      />
                      <span>
                    ...
                    <Col md="12 mb-3">
                      ...
                      <Input
                        ...
                        type="text"
                        placeholder={trans("Enter Instagram User")}
                        innerRef={register({ required: true })}
                      />
                      <span>
                        {errors.instagram_password &&
                          trans("field is required")}
                      </span>
                      <div className="valid-feedback">
                        {trans("Looks good!")}
                      ...
                      <div class="button-labels d-flex">
                        ...
                        {checkedMon == true && (
                          <>
                            ...
                            {/* {console.log(monday.day_start_time)} */}
                          </>
                        )}
                      </div>
