                      ...
                      <div className="row">
                        ...
                        <div className="col-md-6 mt-3">
                          <Label for="first_heading ">
                            {trans("First Heading")} <span className="text-danger">*</span>
                          </Label>
                          <Controller
                            control={EditDeleteControl}
                        ...
                        <div className="col-md-6 mt-3">
                          <Label for="second_heading">
                            {trans("Second Heading")} <span className="text-danger">*</span>
                          </Label>
                          <Controller
                            control={EditDeleteControl}
              ...
              <Accordion className="mt-3">
                ...
                <AccordionDetails>
                  <div className="row">
                    <div className="col-md-12">
                      <Label for="slider_image">
                        {trans("Carousel Image")} <span className="text-danger">*</span>
                      </Label>
                      <Controller
                        control={control}
                        name={`slider_image`}
