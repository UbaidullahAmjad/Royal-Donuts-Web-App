...
const receipe = (props) => {
  ...
  const { all_products, all_ingredients, BasicLineTab } = props;
  let count = 0;
  let count1 = 0;
  ...
  const onSubmit = (data) => {
    ...
    formData.append(
      "product_id",
      SelectedProduct[0]["id"] != null ? SelectedProduct[0]["id"] : params.idd
    );
    formData.append(
      "product_ingredients",
    ...
    if (SelectedProduct != null && EditIngredients.length > 0) {
  ...
  useEffect(() => {
    ...
    if (
      count == 1 &&
      props.all_ingredients.length > 0 &&
      props.BasicLineTab == 2
    ) {
      GetRecipeandIngredients();
    }
    // }
  }, [props.without_filter_ingredients, props.BasicLineTab]);
        ...
        <Row>
          <Col md="6">
            ...
            <Controller
              ...
              defaultValue={SelectedProduct?.length > 0 ? SelectedProduct : ""}
              render={() => (
                <TypeAhead
                  ...
                  LabelKey={"name_fr"}
                  OptionList={all_products != null ? all_products : []}
            ...
            />
            <span>{errors.product && trans("field is required")}</span>
          </Col>
          <Col md="6">
            <Row>
                ...
                <Controller
                  ...
                  render={() => (
                    <TypeAhead
                      ...
                      Key={all_ingredients != null ? all_ingredients : []}
              ...
              <Col md="2">
                <Button color="success" onClick={AddIngredientsSection}>
                  {trans("Add")}
                </Button>
              </Col>
            </Row>
          ...
          >
                          ...
                          <Input
                            ...
                            placeholder={
                              SelectedIngredients.some(
                                (item2) => item.id == item2.ingredient_id
                              ) == true
                  ...
                  <Row>
                    ...
                    <Col md="3">
                      <Input
                        ...
                        placeholder={trans("Extra ingredient quantity")}
                        className="form-control"
                        innerRef={register({
                          required: true,
                        })}
                    ...
                    <Col md="3">
                      <Input
                        ...
                        placeholder={trans("Extra ingredient unit name")}
                        className="form-control"
                        innerRef={register({
                          required: true,
                        })}
                    ...
                    <Col md="2 mb-3 d-flex  justify-content-center align-items-flex-start">
                      ...
                      <Button
                        ...
                        color="danger"
                        outline
                        onClick={() => DeleteExtraIngredient(item, index)}
                      >
                        <i className="fa fa-trash"></i>
                      </Button>
                    </Col>
            ...
            <div>
              {SelectedProduct != null &&
                ...
                ExtraIngredientArray.length == 0 && (
                  <Button color="info" outline onClick={AddExtraIngredients}>
