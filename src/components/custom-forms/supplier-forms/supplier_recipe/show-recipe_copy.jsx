          ...
          <div>
              ...
              <div style={{ marginLeft: 8, display: "flex", flexWrap: "wrap" }}>
                {cellValues.row.product_ingredients ? (
                  cellValues.row.product_ingredients.map(
                    (pd_item, i) =>
                      i <= 2 && (
                        <div className="px-1 mb-1" style={{ marginRight: 8 }}>
                          <span>
                            {AllIngredients &&
                            ...
                            {i < 2 &&
                              i !=
                                cellValues.row.product_ingredients.length - 1 &&
                              ","}
                            {i >= 2 &&
                              i !=
                                cellValues.row.product_ingredients.length - 1 &&
            ...
            {cellValues.row.extra_product_ingredients && (
              <div className="d-flex">
                ...
                <div
                  style={{ marginLeft: 8, display: "flex", flexWrap: "wrap" }}
                >
                  {cellValues.row.extra_product_ingredients &&
                    cellValues.row.extra_product_ingredients.map(
                      (ex_pd_item, i) =>
              ...
              <Row>
                ...
                {(role == "SuperAdmin" ||
                  ...
                  <Col className="text-right">
                    <Link to="/supplier/recipe/create">
                      <Button>
