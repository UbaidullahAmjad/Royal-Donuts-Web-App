...
const Default = (props) => {
  ...
  console.log("USER --- TOKEN ---- ", store_user_token);
  ...
  useEffect(() => {
    ...
    let role = atob(localStorage.getItem("role"));
  ...
  return (
    <Fragment>
      <Breadcrumb parent="Dashboard" title={trans("Default")} />
        ...
        <Row className="second-chart-list third-news-update">
            ...
            <Card>
              <CardHeader>
                <div className="header-top">
                  <h5 className="m-0">{trans(NewsUpdate)}</h5>
              ...
              <Col xl="12" className="appointment">
                <Card>
                  <CardHeader className="card-no-border">
                    <div className="header-top">
                      <h5 className="m-0">{trans(Appointment)}</h5>
                      <div className="card-header-right-icon">
                        <select className="button btn btn-primary">
                          <option>{Today}</option>
                          <option>{Tomorrow}</option>
          ...
          <Col xl="4 xl-50" className="appointment box-col-6">
            <Card>
              <CardHeader>
                <div className="header-top">
                  <h5 className="m-0">{trans(MarketValue)}</h5>
                  <div className="card-header-right-icon">
                    <select className="button btn btn-primary">
                      <option>{Year}</option>
                      <option>{Month}</option>
            ...
            <Card className="chat-default">
              <CardHeader className="card-no-border">
                <div className="media media-dashboard">
                  <div className="media-body">
                    <h5 className="mb-0">{trans(Chat)}</h5>
                  </div>
