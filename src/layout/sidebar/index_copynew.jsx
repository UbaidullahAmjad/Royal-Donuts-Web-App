...
const Sidebar = (props) => {
  ...
  const LinkTo =
    role == atob(localStorage.getItem("role"))
      ...
      : `${process.env.PUBLIC_URL}/suppliers/customer/products/list/${layout}`;
                ...
                <Fragment key={i}>
                  ...
                  {Item.Items.map((menuItem, i) => (
                    ...
                    >
                      ...
                      {menuItem.children ? (
                        <ul
                          // className={`sidebar-submenu ${menuItem.active && localStorage.removeItem("loadMainMenuSidebar")} ${menuItem.children.find((item) => window.location.pathname == item.path + "/" + layout) && !menuItem.active && localStorage.getItem("loadMainMenuSidebar")}`}
                              ...
                              <li key={index}>
                                ...
                                {childrenItem.type === "link" ? (
                                  <Link
                                    ...
                                    // className={`mb-1 ${childrenItem.active && (window.location.pathname == childrenItem.path + "/" + layout) ? "active" : ""
                                    //   } ${(window.location.pathname == childrenItem.path + "/" + layout) && "active"}`}
