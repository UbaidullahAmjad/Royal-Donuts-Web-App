...
export const MENUITEMS = [
  {
    ...
    Items: [
          ...
          children: [
            {
              ...((role === "Lead" || permissions.match("Profile") != null) && {
                title: "Profile",
                icon: PersonOutlineRounded,
                path: `${process.env.PUBLIC_URL}/lead/profile`,
                type: "link",
                // active: false,
              }),
            },
            {
              ...((role === "Lead" || permissions.match("Inquiry") != null) && {
                ...
                path: `${process.env.PUBLIC_URL}/inquiry/view`,
                type: "link",
                // active: false,
              }),
            },
      ...
      {
        ...(role == "Supplier_Customer" && {
          path: `${process.env.PUBLIC_URL}/suppliers/customer/products/list`,
          icon: PersonOutlineRounded,
          // active: true,
          active: false,
          type: "link",
      ...
      {
        ...(role == "Supplier_Customer" && {
          path: `${process.env.PUBLIC_URL}/customer/suppliers/orders`,
          icon: EnhancedEncryptionRounded,
          // active: true,
          active: false,
          type: "link",
