  ...
  useEffect(() => {
    ...
    const url =
      atob(localStorage.getItem("role")) == "Supplier_Customer"
        ? "/suppliers/customer/products/list"
        : "/dashboard/default";
    // const modifyURL = process.env.PUBLIC_URL + url + Object.keys(defaultLayoutObj).pop();
    const modifyURL = process.env.PUBLIC_URL + url;
    ...
    console.log("defaultLayout-id:", id)
    console.log("defaultLayout-layoutobj:", layoutobj)
    console.log("defaultLayout-layout:", layout)
    ...
    if (
      width <= 991 &&
      configDB.settings.sidebar.type.split(" ").includes("horizontal-wrapper")
    ) {
      ...
      document.querySelector(".page-wrapper").className =
        "page-wrapper " + configDB.settings.sidebar.type;
      document.querySelector(".page-header").className = "page-header ";
      document.querySelector(".sidebar-wrapper").className = "sidebar-wrapper ";
    }
                ...
                <ul className="sidebar-type layout-grid">
                  {showHorizontal ? (
                    <li
                      ...
                      onClick={(e) =>
                        handleSidebarType(e, "horizontal-wrapper")
                      }
                    >
                      <div className="header bg-light">
                        <ul>
