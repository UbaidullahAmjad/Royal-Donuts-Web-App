...
export const getPaypalEccomCartAction = () => {
    return async (dispatch) => {
        ...
        await axios({
            ...
            console.log("------- PAYPAL_GET_ECCOM_CART Action-response -------", response);
            ...
            console.log("------- PAYPAL_GET_ECCOM_CART Action-response-error -------", error.response);
            // toast.error(trans("Your Cart List is Empty !!"));
            toast.error("Your Cart List is Empty !!");
            isError = true;
...
export const PaypalPaymentInvoiceAction = (allData, cardData) => {
    return async (dispatch) => {
        ...
        await axios({
            ...
            console.log("------- PAYPAL_GO_TO_INVOICE Action-response -------", response);
            ...
            console.log("------- PAYPAL_GO_TO_INVOICE Action-response-error -------", error.response);
