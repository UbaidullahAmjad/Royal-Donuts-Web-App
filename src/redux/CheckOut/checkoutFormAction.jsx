...
export const checkoutFormFill = (data) => {
  ...
  // console.log("checkoutFormFill --------- formData", data);
  return (dispatch) => {
    // console.log("checkoutFormFill --------- formData- dispatch", data);
    dispatch({
...
export const checkoutFormPushData = (dataObject) => {
  return (dispatch) => {
    // console.log(
    //   "checkoutFormPushData --------- formData- dispatch",
    //   dataObject
    // );
    dispatch({
...
export const checkoutFormSubmit = (onSubmit, errors) => {
  return (dispatch) => {
    // console.log("checkoutFormSubmit --------- formData- dispatch", onSubmit);
    dispatch({
...
export const checkoutFormSubmit_FormData = (data) => {
  return (dispatch) => {
    // console.log(
    //   "checkoutFormSubmit_FormData --------- formData- dispatch",
    //   data
    // );
    dispatch({
