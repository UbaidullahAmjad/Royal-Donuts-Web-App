...
const checkoutFormReducer = (state = initialState, { type, payload }) => {
  switch (type) {
    ...
    case CHECKOUT_FORM_DATA:
      ...
      console.log("CHECKOUT_FORM_DATA ----- Reducer: ", payload);
    ...
    case CHECKOUT_FORM_SUBMIT:
      // console.log("PAYLOAD ----- CHECKOUT_FORM_SUBMIT ---- ", payload);
      return {
        ...state,
        handle_submit: payload,
      };
    case CHECKOUT_FORM_SUBMIT_FORMDATA:
      console.log("PAYLOAD ----- CHECKOUT_FORM_SUBMIT_FORMDATA ---- ", payload);
      return {
        ...state,
        formData: payload,
      };
