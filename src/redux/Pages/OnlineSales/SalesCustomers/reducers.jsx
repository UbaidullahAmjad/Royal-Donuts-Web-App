...
const SalesCustomersReducer = (state = initialState, { type, payload }) => {
    switch (type) {
        case SALES_CUSTOMERS_LIST: {
            // console.log("--SALES_CUSTOMERS_LIST REDUCER", payload);
        ...
        case SALES_CUSTOMER_DELETE: {
            // console.log("--SALES_CUSTOMER_DELETE REDUCER", payload);
            // console.log("--SALES_CUSTOMER_DELETE salesCustomersList", state.salesCustomersList);
        ...
        case SALES_ORDER_CREATE: {
            // console.log("--SALES_ORDER_CREATE REDUCER", payload);
            // console.log("--SALES_ORDER_CREATE salesCustomersList", state.salesCustomersList);
        ...
        case SALES_ORDER_EDIT: {
            // console.log("--SALES_ORDER_EDIT REDUCER", payload);
            // console.log("--SALES_ORDER_EDIT salesCustomersList", state.salesCustomersList);
            let newTempArrLength = state.salesCustomersList.length;
            if (state.salesCustomersList.length > 0 && payload.isError == false) {
                newTempArrLength = newTempArrLength + 1;
            }
