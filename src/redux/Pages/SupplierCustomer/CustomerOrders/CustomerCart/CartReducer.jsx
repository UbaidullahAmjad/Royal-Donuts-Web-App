...
const SuppllierCustomerCartReducer = (state = initialState, { type, payload }) => {
    ...
    switch (type) {
        case SUPPLIER_CUSTOMER_CART_DATA: {
            console.log("--SUPPLIER_CUSTOMER_CART_DATA REDUCER", payload);
            let allCarts = [];
            ...
            console.log("--SUPPLIER_CUSTOMER_CART_DATA allCarts", allCarts);
            console.log("--SUPPLIER_CUSTOMER_CART_DATA DELIVERY COMMM ---- ", delivery_company_duplication_state);
            return {
                ...state,
