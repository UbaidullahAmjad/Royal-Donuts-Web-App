...
const PaypalPaymentReducer = (state = initialState, { type, payload }) => {
    ...
    switch (type) {
        case PAYPAL_PAYMENT_GET_DATA: {
            // console.log("--PAYPAL_PAYMENT_GET_DATA REDUCER", payload);
            let paypalPaymentData = "";
            if (payload.response != null) {
                paypalPaymentData = payload.response.data;
                state.tempArrLength = 1;
            }
            // console.log("--PAYPAL_PAYMENT_GET_DATA paypalPaymentData:", paypalPaymentData);
            return {
                ...state,
        ...
        case PAYPAL_PAYMENT_SAVE_DATA: {
            // console.log("--PAYPAL_PAYMENT_SAVE_DATA REDUCER", payload);
            // console.log("--PAYPAL_PAYMENT_SAVE_DATA paypalPayment", state.paypalPayment);
