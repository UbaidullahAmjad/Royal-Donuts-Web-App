...
const StripePaymentReducer = (state = initialState, { type, payload }) => {
    ...
    switch (type) {
        case STRIPE_PAYMENT_GET_DATA: {
            // console.log("--STRIPE_PAYMENT_GET_DATA REDUCER", payload);
            let stripePaymentData = "";
            if (payload.response != null) {
                stripePaymentData = payload.response.data;
                state.tempArrLength = 1;
            }
            // console.log("--STRIPE_PAYMENT_GET_DATA stripePaymentData:", stripePaymentData);
            return {
                ...state,
        ...
        case STRIPE_PAYMENT_SAVE_DATA: {
            // console.log("--STRIPE_PAYMENT_SAVE_DATA REDUCER", payload);
            // console.log("--STRIPE_PAYMENT_SAVE_DATA stripePayment", state.stripePayment);
