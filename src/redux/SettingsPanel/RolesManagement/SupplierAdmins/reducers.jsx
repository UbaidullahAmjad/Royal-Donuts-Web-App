...
const SupplierAdminsReducer = (state = initialState, { type, payload }) => {
    switch (type) {
        case ADMINS_LIST: {
            // console.log("--ADMINS_LIST REDUCER", payload);
            let allAdmins = [];
        ...
        case ADMIN_DELETE: {
            // console.log("--ADMIN_DELETE REDUCER", payload);
            // console.log("--ADMIN_DELETE adminsList", state.adminsList);
        ...
        case ADMIN_CREATE: {
            // console.log("--ADMIN_CREATE REDUCER", payload);
            // console.log("--ADMIN_CREATE categories", state.adminsList);
        ...
        case ADMIN_EDIT: {
            // console.log("--ADMIN_EDIT REDUCER", payload);
            // console.log("--ADMIN_EDIT products", state.adminsList);
            let newTempArrLength = state.adminsList.length;
            if (state.adminsList.length > 0 && payload.isError == false) {
                newTempArrLength = newTempArrLength + 1;
            }
